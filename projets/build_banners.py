...
BANNERS = [
    ...
    {
        "id": "hotelchain_nb2_enonce",
        "tag": "DATAPROJECTLAB  ·  VERSION APPRENANT",
        "title": "HotelChainWest Analytics",
        "subtitle": "SQL Analytics & EDA — Occupation, RevPAR, CLV",
        "meta": ["Niveau Intermediaire", "Duree 3 h", "Python, DuckDB (JupySQL), matplotlib"],
    },
    {
        "id": "hotelchain_nb2_solution",
        "tag": "DATAPROJECTLAB  ·  VERSION CORRIGEE",
        "title": "HotelChainWest Analytics",
        "subtitle": "SQL Analytics & EDA — Occupation, RevPAR, CLV",
        "meta": ["Niveau Intermediaire", "Duree 3 h", "Python, DuckDB (JupySQL), matplotlib"],
    ...
    {
        "id": "hotelchain_nb3_enonce",
        "tag": "DATAPROJECTLAB  ·  VERSION APPRENANT",
        "title": "HotelChainWest Analytics",
        "subtitle": "Machine Learning — Prevision d'occupation & segmentation client",
        "meta": ["Avance", "Duree 3 - 4 h", "scikit-learn, segmentation, time-series"],
    },
    {
        "id": "hotelchain_nb3_solution",
        "tag": "DATAPROJECTLAB  ·  VERSION CORRIGEE",
        "title": "HotelChainWest Analytics",
        "subtitle": "Machine Learning — Prevision d'occupation & segmentation client",
        "meta": ["Avance", "Duree 3 - 4 h", "scikit-learn, segmentation, time-series"],
    ...
    },
    {
        ...
        "tag": "DATAPROJECTLAB  ·  VERSION APPRENANT",
        "title": "TelcomCI RH Analytics",
        "subtitle": "SQL Analytics & EDA — Effectifs, salaires, absenteisme",
        "meta": ["Niveau Intermediaire", "Duree 3 h", "Python, DuckDB (JupySQL), matplotlib"],
    },
    {
        "id": "rh_nb2_solution",
    ...
    },
    {
        ...
        "tag": "DATAPROJECTLAB  ·  VERSION APPRENANT",
        "title": "TelcomCI RH Analytics",
        "subtitle": "Machine Learning — Prediction d'attrition & recommandations RH",
        "meta": ["Avance", "Duree 3 - 4 h", "scikit-learn, classification, feature importance"],
    },
    {
        "id": "rh_nb3_solution",
        "tag": "DATAPROJECTLAB  ·  VERSION CORRIGEE",
